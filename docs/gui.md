...
3.  **Aspect Ratio Scaling to 20x20**: The MNIST dataset typically contains digits scaled to fit within a 20x20 pixel box, which is then placed in the center of a 28x28 canvas [[1]](#ref-lecun-1998). To mimic this, the cropped digit is scaled to fit a 20x20 square while preserving its aspect ratio:
